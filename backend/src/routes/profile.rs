...
pub async fn list_passkeys(
    ...
    conn.scoped(|tx| ProfileService::new(&state).list_passkeys(tx, user_id))
}
...
pub async fn list_api_tokens(
    ...
    conn.scoped(|tx| ProfileService::new(&state).list_api_tokens(tx, tenant_id, user_id))
}
...
pub async fn create_api_token(
    ...
    conn.scoped(|tx| ProfileService::new(&state).create_api_token(tx, tenant_id, user_id, payload))
}
...
pub async fn regenerate_api_token(
    ...
    conn.scoped(|tx| {
        ProfileService::new(&state).regenerate_api_token(tx, tenant_id, user_id, token_id)
    })
}
...
pub async fn delete_api_token(
    ...
    conn.scoped(|tx| ProfileService::new(&state).delete_api_token(tx, user_id, token_id))
}
...
pub async fn delete_passkey(
    ...
    conn.scoped(|tx| ProfileService::new(&state).delete_passkey(tx, user_id, passkey_id, query.reason))
}
